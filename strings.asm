...
msg2 DB "mondo",10,13,"$" ;puoi innestare anche codici ASCII (13=CR) e (10=LF)
msg3 DB "sono io",07,"$"  ;ASCII 7 beep
msg4 DB 'a','b','c', '$'  ;insieme di caratteri
msg5 DB 31h,32h,'$';      ;insieme di codici ASCII (esadecimali)
...
LEA DX, newline ; nuova linea
INT 21h

LEA DX, msg4  ; stampo l'insieme di caratteri
INT 21h
...
LEA DX, msg5  ; stampo l'insieme di caratteri
INT 21h
